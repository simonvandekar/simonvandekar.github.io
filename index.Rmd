...
My work develops statistical inference methods and software that can be used for scientific insight in medical imaging, including magnetic resonance imaging and multiplexed immunofluorescence imaging. In collaborative research, I utilize statistical tools such as generalized additive models, latent variable models, random effects models, semiparametric methods, estimating equations, and machine learning. My statistical research focuses on robust inference procedures for high-dimensional imaging data using semiparametric methods. Lately, I am particularly interested in the use of robust effect sizes based in semiparametric theory and replicability in medical imaging.

Collaborating with students is one of the greatest pleasures of my job. Please reach out if you are interested in working together.
